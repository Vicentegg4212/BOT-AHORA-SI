...
// ═══════════════════════════════════════════════════════════════════════════
// FUNCIÓN DE STREAMING A KICK (YOUTUBE)
// ═══════════════════════════════════════════════════════════════════════════
        ...
        try {
            await page.evaluate(() => {
                const acceptButton = Array.from(document.querySelectorAll('button')).find(btn => 
                    btn.textContent?.includes('Aceptar') || btn.textContent?.includes('Accept')
                );
...
// Exportar función para usar desde comandos
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { streamToKick };
}

// Si se ejecuta directamente, iniciar streaming
